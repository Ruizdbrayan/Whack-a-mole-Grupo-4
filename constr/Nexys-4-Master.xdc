...
set_property PACKAGE_PIN T8 [get_ports led_estado]					
	set_property IOSTANDARD LVCMOS33 [get_ports led_estado]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {leds[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[0]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {leds[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[1]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {leds[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[2]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {leds[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[3]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {leds[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[4]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {leds[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[5]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {leds[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {leds[6]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {leds[7]}]					
...
set_property PACKAGE_PIN L3 [get_ports {display_7seg[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[6]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {display_7seg[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[5]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {display_7seg[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[4]}]
##Bank = 34, Pin name =x IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {display_7seg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {display_7seg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[2]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {display_7seg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {display_7seg[1]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {display_7seg[0]}]					
...
set_property PACKAGE_PIN N6 [get_ports {select_7seg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_7seg[1]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {select_7seg[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_7seg[0]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {select_7seg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_7seg[3]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {select_7seg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {select_7seg[2]}]
...
#set_property PACKAGE_PIN F15 [get_ports {botones[0]}]						
	#set_property IOSTANDARD LVCMOS33 [get_ports {botones[0]}]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports {botones[1]}]						
    #set_property IOSTANDARD LVCMOS33 [get_ports {botones[1]}]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports {botones[2]}]						
...
set_property PACKAGE_PIN B13 [get_ports {leds[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[0]}]
	set_property PULLDOWN true [get_ports {leds[0]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {leds[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[1]}]
	set_property PULLDOWN true [get_ports {leds[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {leds[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[2]}]
	set_property PULLDOWN true [get_ports {leds[2]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {leds[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[3]}]
	set_property PULLDOWN true [get_ports {leds[3]}]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {leds[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[4]}]
	set_property PULLDOWN true [get_ports {leds[4]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {leds[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[5]}]
	set_property PULLDOWN true [get_ports {leds[5]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {leds[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[6]}]
	set_property PULLDOWN true [get_ports {leds[6]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports {leds[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[7]}]
	set_property PULLDOWN true [get_ports {leds[7]}]



##Pmod Header JB
##Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = JB1
set_property PACKAGE_PIN G14 [get_ports {botones[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[0]}]
	set_property PULLDOWN true [get_ports {botones[0]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {botones[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[1]}]
	set_property PULLDOWN true [get_ports {botones[1]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {botones[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[2]}]
	set_property PULLDOWN true [get_ports {botones[2]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {botones[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[3]}]
	set_property PULLDOWN true [get_ports {botones[3]}]
##Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {botones[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[4]}]
	set_property PULLDOWN true [get_ports {botones[4]}]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {botones[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[5]}]
	set_property PULLDOWN true [get_ports {botones[5]}]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {botones[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[6]}]
	set_property PULLDOWN true [get_ports {botones[6]}]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {botones[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {botones[7]}]
	set_property PULLDOWN true [get_ports {botones[7]}]
 


##Pmod Header JC
##Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports topo_generado]					
	set_property IOSTANDARD LVCMOS33 [get_ports topo_generado]
